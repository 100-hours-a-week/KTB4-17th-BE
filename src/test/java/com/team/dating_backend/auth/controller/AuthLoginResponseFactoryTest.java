...
class AuthLoginResponseFactoryTest {
    ...
    void setUp() {
        ...
        AuthCookieFactory authCookieFactory =
                new AuthCookieFactory(authWebProperties, jwtProperties);
        authLoginResponseFactory =
                new AuthLoginResponseFactory(jwtService, authCookieFactory, authWebProperties);
    }
    ...
    void ONBOARDING_회원은_ACCESS_TOKEN으로_온보딩_목적지에_진입한다() {
        ...
        SocialLoginResult loginResult =
                new SocialLoginResult.Authenticated(2L, LoginDestination.ONBOARDING);
